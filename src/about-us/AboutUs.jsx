    ...
    <>
      <div className="homepage-container">
        ...
        <p>
          ...
          understanding of JavaScript and are looking to take their first steps
        ...
        <p>You’ll find chapters that introduce you to key topics, including:</p>
        ...
        <p>
          Each section is structured to help you build a solid foundation and
          gain confidence in using React to create interactive, dynamic web
          applications.
        </p>
        ...
        <p>
          ...
          development, this page is your guide to mastering the basics of React.
        </p>
